...
const YesTheoryUploadedPing = async (message: Message) => {
    ...
    const channelDiscussion = message.guild.channels.cache.find((channel) => channel.name === ChatNames.YESTHEORY_DISCUSSION.toString()) as TextChannel
    const embed = new Discord.MessageEmbed()
    .setColor("BLUE")
    .setTitle("YesTheory Uploaded!")
    .setDescription(`Yes Theory posted a new video! Go check it out in ${message.channel.toString()} and talk about it here`)
