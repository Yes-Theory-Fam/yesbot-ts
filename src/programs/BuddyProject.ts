...
Hey there! Thank you for signing up to be a part of the Buddy Project :speech_balloon: . You’ve been paired with <@${
  match.id
}> (${match.username}#${match.discriminator}) If it's unclear on how to contact this person, please ask for help in <#701717612001886228> by copying and pasting this: \`<@${
  match.id
