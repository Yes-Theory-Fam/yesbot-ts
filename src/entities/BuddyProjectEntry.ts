...
export class BuddyProjectEntry {
  ...
  @Column("timestamp with time zone", { nullable: true, default: null, name: "matched_date" })
  matchedDate: Date;

  @Column("timestamp with time zone", { nullable: true, default: null, name: "reported_ghost_date" })
