...
bot.on("guildMemberSpeaking", (member: GuildMember, speaking: boolean) => null);
bot.on("guildMemberUpdate", (oldMember: GuildMember, newMember: GuildMember) => new GuildMemberUpdate(oldMember, newMember));
